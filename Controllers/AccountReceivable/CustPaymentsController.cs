...
{
    public class CustPaymentsController : BaseApiController
    {
        [HttpGet("GetList")]
        public ActionResult GetList(int pageSize, int pageNumber, string? orderBy = "", string? orderDirection = "", string? criteria = "")
        {
            try
            {
                ...
                var x = DataHelper.ExecScalar("fcs_CustPaymentsGetList", System.Data.CommandType.StoredProcedure, l.ToArray());
        ...
        [HttpGet("GetCustDues")]
        public ActionResult GetCustDues(string CustomerID, int? TransTypeID, int? CurrencyID)
        {
            try
            {
                ...
                var x = DataHelper.ExecScalar("fcs_CustPaymentsGetCustDues", System.Data.CommandType.StoredProcedure, l.ToArray());
                if (string.IsNullOrEmpty(x.ToString()))
                {
                    return StatusCode(200, "");
                }
        ...
        public ActionResult GetByID(int ID)
        {
            try
            {
                ...
                DataHelper.ExecScalar("fcs_CustPaymentDetails", System.Data.CommandType.StoredProcedure, ref listOutPutParams, l.ToArray());
        ...
        public ActionResult GetNextCode(int TransTypeID, string PaymentDate)
        {
            try
            {
                ...
                l.Add(new SqlParameter("@TransTypeID", TransTypeID));
                l.Add(new SqlParameter("@TableName", "fcs_CustPayments"));
                List <SqlParameter> listOutPutParams = new List<SqlParameter>();
        ...
        public ActionResult Save(DataObj dataObj)
        {
            try
            {
                ...
                DataHelper.ExecScalar("fcs_CustPaymentsSave", System.Data.CommandType.StoredProcedure, ref listOutParameters, l.ToArray());
        ...
        [HttpGet("Delete")]
        public ActionResult Delete(int CustPaymentId)
        {
            try
            {
                ...
                l.Add(new SqlParameter("@FormId",  ExtractFormId()));
                l.Add(new SqlParameter("@Lang", ExtractLang()));
                l.Add(new SqlParameter("@ID", CustPaymentId));

                List<SqlParameter> listOutParameters = new List<SqlParameter>();
                SqlParameter errPar = new SqlParameter() { ParameterName = "@Error", SqlDbType = SqlDbType.NVarChar, Size = -1, Direction = ParameterDirection.Output };
                listOutParameters.Add(errPar);
                var x = DataHelper.ExecScalar("fcs_CustPaymentsDelete", System.Data.CommandType.StoredProcedure, ref listOutParameters, l.ToArray());
                string error = listOutParameters.Find(X => X.ParameterName == "@Error").Value.ToString();
                if (!string.IsNullOrEmpty(error))
                    return StatusCode(500, error);
