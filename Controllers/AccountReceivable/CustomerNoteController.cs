...
{
    public class CustomerNoteController : BaseApiController
    {
        [HttpGet("GetList")]
        public ActionResult GetList(int pageSize, int pageNumber, string? orderBy = "", string? orderDirection = "", string? criteria = "")
        {
            try
            {
                ...
                var x = DataHelper.ExecScalar("fcs_CustomerNoteList", CommandType.StoredProcedure, l.ToArray());
        ...
        public ActionResult GetByID(int ID)
        {
            try
            {
                ...
                DataHelper.ExecScalar("fcs_CustomerNoteDetails", CommandType.StoredProcedure, ref listOutPutParams, l.ToArray());
        ...
        public ActionResult GetNextCode(int TransTypeID, string NoteDate)
        {
            try
            {
                ...
                l.Add(new SqlParameter("@TableName", "fcs_CustomerNote"));
                List<SqlParameter> listOutPutParams = new List<SqlParameter>();
                ...
                if (string.IsNullOrEmpty(lastSeq.ToString()))
                {
                    return StatusCode(200, "");
                }
        ...
        [HttpGet("srchCustomers")]
        public ActionResult srchCustomers(string? ExciptIds = "", string? Filter = "")
        {
            try
            {
                List<SqlParameter> l = new List<SqlParameter>();
                ...
                var x = DataHelper.ExecScalar("fcs_srchCustomers", System.Data.CommandType.StoredProcedure, l.ToArray());
                if (string.IsNullOrEmpty(x.ToString()))
                {
                    return StatusCode(200, "");
                }
        ...
        public ActionResult Save(DataObj dataObj)
        {
            try
            {
                ...
                DataHelper.ExecScalar("fcs_CustomerNoteSave", System.Data.CommandType.StoredProcedure, ref listOutParameters, l.ToArray());
        ...
        public ActionResult Delete(DataObj dataObj)
        {
            try
            {
                ...
                DataHelper.ExecScalar("fcs_CustomerNoteDelete", System.Data.CommandType.StoredProcedure, ref listOutParameters, l.ToArray());
                string error = listOutParameters.Find(X => X.ParameterName == "@Error").Value.ToString();
                if (!string.IsNullOrEmpty(error))
                    return StatusCode(500, error);
