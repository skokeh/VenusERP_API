...
{
    public class VendorJournalController : BaseApiController
    {
        [HttpGet("GetList")]
        public ActionResult GetList(int pageSize, int pageNumber, string? orderBy = "", string? orderDirection = "", string? criteria = "")
        {
            try
            {
                ...
                var x = DataHelper.ExecScalar("fcs_VendorJourGetList", System.Data.CommandType.StoredProcedure, l.ToArray());
        ...
        public ActionResult GetByID(int ID)
        {
            try
            {
                ...
                DataHelper.ExecScalar("fcs_VendorJourDetails", System.Data.CommandType.StoredProcedure, ref listOutPutParams, l.ToArray());
        ...
        public ActionResult GetNextCode(int TransTypeID, string? JournalDate)
        {
            try
            {
                ...
                l.Add(new SqlParameter("@TableName", "fcs_VendorJour"));
                List<SqlParameter> listOutPutParams = new List<SqlParameter>();
        ...
        public ActionResult Save(DataObj dataObj)
        {
            try
            {
               ...
               List<SqlParameter> l = new List<SqlParameter>();
                ...
                DataHelper.ExecScalar("fcs_VendorJourSave", System.Data.CommandType.StoredProcedure, ref listOutParameters, l.ToArray());
        ...
        public ActionResult Delete(DataObj dataObj)
        {
            try
            {
                ...
                List<SqlParameter> listOutParameters = new List<SqlParameter>();
                DataHelper.ExecScalar("fcs_VendorJourDelete", System.Data.CommandType.StoredProcedure, ref listOutParameters, l.ToArray());
