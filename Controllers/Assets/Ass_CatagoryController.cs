...
{
    public class Ass_CatagoryController : BaseApiController
    {
        [HttpGet("GetList")]
        public ActionResult GetList(int pageSize, int pageNumber, string? orderBy = "", string? orderDirection = "", string? criteria = "")
        {
            try
            {
                ...
                var x = DataHelper.ExecScalar("Ass_Catagory_GetList", System.Data.CommandType.StoredProcedure, l.ToArray());
        ...
        public ActionResult Save(DataObj dataObj)
        {
            try
            {
                ...
                DataHelper.ExecScalar("Ass_Catagory_Save", System.Data.CommandType.StoredProcedure, ref listOutParameters, l.ToArray());
