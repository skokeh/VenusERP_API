...
{
    public class Ass_DepreciationItemsController : BaseApiController
    {
        [HttpGet("GetList_ToDepreciation")]
        public ActionResult GetList_ToDepreciation(int pageSize, int pageNumber, string? orderBy = "", string? orderDirection = "", string? criteria = "")
        {
            try
            {
                ...
                var x = DataHelper.ExecScalar("Ass_DepreciationItems_GetList", System.Data.CommandType.StoredProcedure, l.ToArray());
        ...
        [HttpGet("DepreciationDone")]
        public ActionResult DepreciationDone(int ID,int AssItemId)
        {
            try
            {
                ...
                DataHelper.ExecScalar("Ass_Depreciation_Done", System.Data.CommandType.StoredProcedure, ref listOutParameters, l.ToArray());
        ...
        [HttpGet("GetDepreciation_Book")]
        public ActionResult GetDepreciation_Book(int AssItemId)
        {
            try
            {
                List<SqlParameter> l = new List<SqlParameter>();
                ...
                var x = DataHelper.ExecScalar("Ass_Depreciation_Book", System.Data.CommandType.StoredProcedure, l.ToArray());
                if (string.IsNullOrEmpty(x.ToString()))
                {
                    return StatusCode(200, "");
                }
